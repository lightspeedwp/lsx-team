<div class="uix-field-wrapper">
    <ul class="ui-tab-nav">
        <?php if (class_exists('LSX_Banners')) { ?>
            <li><a href="#ui-placeholders" class="active"><?php esc_html_e('Placeholders', 'lsx-team'); ?></a></li>
        <?php } ?>

        <?php if (class_exists('LSX_Currencies')) { ?>
            <?php $class_active = class_exists('LSX_Banners') ? '' : 'active'; ?>
            <li><a href="#ui-currencies" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Currencies', 'lsx-team'); ?></a></li>
        <?php } ?>

        <?php if (class_exists('LSX_Team')) { ?>
            <?php $class_active = ( class_exists('LSX_Banners') || class_exists('LSX_Currencies') ) ? '' : 'active'; ?>
            <li><a href="#ui-team" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Team', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Testimonials')) { ?>
            ...
            <li><a href="#ui-testimonials" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Testimonials', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Projects')) { ?>
            ...
            <li><a href="#ui-projects" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Projects', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Services')) { ?>
            ...
            <li><a href="#ui-services" class="<?php echo esc_attr($class); ?>"><?php esc_html_e('Services', 'lsx-team'); ?></a></li>
        <?php
        $class = '';
}
?>
        ...
        <?php if (class_exists('LSX_Blog_Customizer')) { ?>
            ...
            <li><a href="#ui-blog-customizer" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Blog Customizer (posts widget)', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Sharing')) { ?>
            ...
            <li><a href="#ui-sharing" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Sharing', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Videos')) { ?>
            ...
            <li><a href="#ui-videos" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Videos', 'lsx-team'); ?></a></li>
        <?php } ?>
        ...
        <?php if (class_exists('LSX_Search')) { ?>
            ...
            <li><a href="#ui-search" class="<?php echo esc_attr($class_active); ?>"><?php esc_html_e('Search', 'lsx-team'); ?></a></li>
        <?php } ?>
    </ul>
