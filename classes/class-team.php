...
class LSX_Team
{
    ...
    public function __construct()
    {
        ...
        add_filter('lsx_banner_allowed_post_types', [ $this, 'lsx_banner_allowed_post_types' ]);
    ...
    }//end lsx_banner_allowed_post_types()
    ...
    {
        add_filter('lsx_placeholder_url', [ $this, 'placeholder' ], 10, 1);
        add_filter('lsx_to_placeholder_url', [ $this, 'placeholder' ], 10, 1);
        ...
        if (! empty(get_the_post_thumbnail($post_id)) || ! empty(get_post_meta($post_id, 'lsx_email_gravatar', true))) {
            if (! empty(get_the_post_thumbnail($post_id))) {
                ...
                $thumbnail = get_avatar(
                    get_post_meta($post_id, 'lsx_email_gravatar', true),
                    $size,
                    $this->options['display']['team_placeholder'],
                    false,
                    ['class' => $thumbnail_class]
                );
            }
        ...
        remove_filter('lsx_placeholder_url', [ $this, 'placeholder' ], 10, 1);
        remove_filter('lsx_to_placeholder_url', [ $this, 'placeholder' ], 10, 1);
